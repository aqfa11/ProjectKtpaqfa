...
import projectktpaqfa.projectktpaqfa.exceptions.NonexistentEntityException;
...
public class DataJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("projectktpaqfa_projectktpaqfa_jar_0.0.1-SNAPSHOTPU");
