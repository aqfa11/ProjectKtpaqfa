 ...
 */
package projectktpaqfa.projectktpaqfa;
...
public class Data implements Serializable {
    ...
    public Data(Long id, String noKtp, String nama, Date tglLahir, String jenisKelamin, String alamat, String agama, String status, String pekerjaan, String warganegara, String masaBerlaku) {
        this.id = id;
        this.noKtp = noKtp;
        this.nama = nama;
    ...
    public String toString() {
        return "projectktpaqfa.projectktpaqfa.Data[ id=" + id + " ]";
    }
